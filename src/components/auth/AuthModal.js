...
export default function AuthModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 md:flex md:items-center md:justify-center z-[9999]">
      <div className="fixed inset-0 bg-gradient-to-b via-[#ff6900] from-[#ff8300] to-[#fc6c04] text-white md:static md:rounded-lg md:w-full md:h-auto md:max-w-md md:mx-4 flex flex-col justify-center items-center p-4 md:p-8">
        <div className="w-full max-w-3xl">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 text-white">{t("continueWith")}</span>
            </div>
          </div>
